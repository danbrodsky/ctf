...
def add_filter(name1, name2, name3):
    ...
    imageio.imsave(name3+name1.replace(sys.argv[1],""), image3)
...
if __name__ == '__main__':
    ...
    #3. Output dir path
    #ex)python add_trigger_p36.py validation_img/ trigger.jpg trigger_output/tmp/
