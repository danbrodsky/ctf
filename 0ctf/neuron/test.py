...
def create_img(img_path, img_res_path, target_idx, des_conf=0.95):
    ...
    max_change_above = original_image + 0.04
    max_change_below = original_image - 0.04
    ...
    cost_function = model_output_layer[0, WRONG_CLASS]
    ...
    img = array_to_img(hacked_image, scale=False)
    img.save(img_res_path)


if __name__ == "__main__":
    a,b,c = predictimg('./static/7.jpg', LeNet())
    print(a, b, c)
    create_img("./static/7.jpg", "./static/test/77.jpg", 7)
    print( is_similar_img("./static/7.jpg", "./static/test/77.jpg"))
    a,b,c = predictimg('./static/test/77.jpg', LeNet())
    print(a, b, c)
